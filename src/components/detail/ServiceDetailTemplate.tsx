...
export async function ServiceDetailTemplate({ service }: ServiceDetailTemplateProps) {
  return (
    <article className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      <header className="mb-12 border-b border-stone-200 pb-8">
        ...
        {service.date ? (
          <div className="mt-6 text-sm text-stone-500">{formatDisplayDate(service.date)}</div>
        ) : null}
      </header>
      <div className="mb-10">
